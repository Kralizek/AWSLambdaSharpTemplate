...
public abstract class CognitoCreateAuthChallengeFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoCreateAuthChallengeEvent, CognitoCreateAuthChallengeEvent, THandler>
...
public abstract class CognitoCustomEmailSenderFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoCustomEmailSenderEvent, CognitoCustomEmailSenderEvent, THandler>
...
public abstract class CognitoCustomMessageFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoCustomMessageEvent, CognitoCustomMessageEvent, THandler>
...
public abstract class CognitoCustomSmsSenderFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoCustomSmsSenderEvent, CognitoCustomSmsSenderEvent, THandler>
...
public abstract class CognitoDefineAuthChallengeFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoDefineAuthChallengeEvent, CognitoDefineAuthChallengeEvent, THandler>
...
public abstract class CognitoUserMigrationFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoMigrateUserEvent, CognitoMigrateUserEvent, THandler>
...
public abstract class CognitoPostAuthenticationFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPostAuthenticationEvent, CognitoPostAuthenticationEvent, THandler>
...
public abstract class CognitoPostConfirmationFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPostConfirmationEvent, CognitoPostConfirmationEvent, THandler>
...
public abstract class CognitoPreAuthenticationFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPreAuthenticationEvent, CognitoPreAuthenticationEvent, THandler>
...
public abstract class CognitoPreSignUpFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPreSignupEvent, CognitoPreSignupEvent, THandler>
...
public abstract class CognitoPreTokenGenerationFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPreTokenGenerationEvent, CognitoPreTokenGenerationEvent, THandler>
...
public abstract class CognitoPreTokenGenerationV2Function<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoPreTokenGenerationV2Event, CognitoPreTokenGenerationV2Event, THandler>
...
public abstract class CognitoVerifyAuthChallengeFunction<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THandler> : RequestFunction<CognitoVerifyAuthChallengeEvent, CognitoVerifyAuthChallengeEvent, THandler>
