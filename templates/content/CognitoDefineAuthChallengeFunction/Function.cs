...
public sealed class Function : CognitoDefineAuthChallengeFunction<DefineAuthChallengeHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoDefineAuthChallengeEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoDefineAuthChallengeEvent input, ILambdaContext context)
    {
        try
        {
