...
public sealed class Function : CognitoCustomSmsSenderFunction<CustomSmsSenderHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoCustomSmsSenderEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoCustomSmsSenderEvent input, ILambdaContext context)
    {
        try
        {
