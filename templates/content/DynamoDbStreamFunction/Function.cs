...
public sealed class Function : DynamoDbStreamFunction<DynamoDbRecordHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.DynamoDBEvents.StreamsEventResponse> FunctionHandlerAsync(
        Amazon.Lambda.DynamoDBEvents.DynamoDBEvent input,
