...
public sealed class Function : CognitoPreSignUpFunction<PreSignUpHandler>
{
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoPreSignupEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoPreSignupEvent input, ILambdaContext context)
    {
        try
        {
