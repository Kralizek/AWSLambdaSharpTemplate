...
internal static class LambdaAot
{
    private static async Task Main()
    {
        ...
        var bootstrap = LambdaBootstrapBuilder.Create<Amazon.Lambda.CloudWatchEvents.CloudWatchEvent<OrderCreated>>(
...
[JsonSerializable(typeof(Amazon.Lambda.CloudWatchEvents.CloudWatchEvent<OrderCreated>))]
