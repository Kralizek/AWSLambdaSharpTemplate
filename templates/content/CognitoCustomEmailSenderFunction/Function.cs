...
public sealed class Function : CognitoCustomEmailSenderFunction<CustomEmailSenderHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoCustomEmailSenderEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoCustomEmailSenderEvent input, ILambdaContext context)
    {
        try
        {
