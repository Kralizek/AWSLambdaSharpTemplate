...
public sealed class Function : CognitoPostAuthenticationFunction<PostAuthenticationHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoPostAuthenticationEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoPostAuthenticationEvent input, ILambdaContext context)
    {
        try
        {
