...
public sealed class Function : CognitoVerifyAuthChallengeFunction<VerifyAuthChallengeHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoVerifyAuthChallengeEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoVerifyAuthChallengeEvent input, ILambdaContext context)
    {
        try
        {
