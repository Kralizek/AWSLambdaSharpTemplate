...
public sealed class Function : CognitoPostConfirmationFunction<PostConfirmationHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoPostConfirmationEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoPostConfirmationEvent input, ILambdaContext context)
    {
        try
        {
