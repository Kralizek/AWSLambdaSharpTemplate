...
public sealed class Function : CognitoCustomMessageFunction<CustomMessageHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoCustomMessageEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoCustomMessageEvent input, ILambdaContext context)
    {
        try
        {
