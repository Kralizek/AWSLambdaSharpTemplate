...
public sealed class Function : CognitoCreateAuthChallengeFunction<CreateAuthChallengeHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoCreateAuthChallengeEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoCreateAuthChallengeEvent input, ILambdaContext context)
    {
        try
        {
