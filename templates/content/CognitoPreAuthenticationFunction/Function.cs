...
public sealed class Function : CognitoPreAuthenticationFunction<PreAuthenticationHandler>
{
#if (otel)
    ...
    public override async Task<Amazon.Lambda.CognitoEvents.CognitoPreAuthenticationEvent> FunctionHandlerAsync(Amazon.Lambda.CognitoEvents.CognitoPreAuthenticationEvent input, ILambdaContext context)
    {
        try
        {
