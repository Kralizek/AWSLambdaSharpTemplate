...
- Added `Kralizek.Lambda.Template.TenantRouting` for synchronous tenant-aware downstream Lambda invocation, plus `--tenant` on the SQS project template with Native AOT and OpenTelemetry composition.
